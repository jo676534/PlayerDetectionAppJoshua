...
# http://172.19.0.2:5000/get
# http://172.21.0.2:5000/get this is the current address that the flask runs on


scene_segmentation_endpoint = "http://172.21.0.2:5000/get"  # this is a flask environment running on my local computer for testing
