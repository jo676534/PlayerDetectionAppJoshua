...
completed_requests = html.Div(children=[
        dbc.CardHeader(children=[dbc.Label(children='Completed Requests:',
        style={'display':'inline-block', 'margin-right':'150px'}), 
        dbc.Button(id='go_to_search_engine',children='Go to Search Engine',color='success')]),
        ...
        [
           dash_table.DataTable(
                    ...
                    style_cell={'padding-left': '5px', 'font_family': 'Helvetica',},
                    style_header={
...
pending_request_card = html.Div(children=[
        
        dbc.CardHeader(children=[dbc.Label(children='Pending Requests:',
        style={'display':'inline-block', 'margin-right':'100px'}), 

        dbc.Button(id='new_request',children='New Request',color='primary',href='/apps/upload',style={'display':'inline-block','margin-right':'10px'}),
...
dropdown_inside_header = dcc.Dropdown(id='view_select_team',
                                options=[{'label':'N/A','value':-1}],
                                style={'width': '90%', 'display': 'inline-block', }
                                )

look_at_your_team_container = html.Div(children=[
...
main_card = dbc.Card(
    ...
    children=[
        ...
        dbc.CardHeader(children=html.H3(children='Welcome to Sports Science AI!',style={'text-align':'center'})),
        dbc.CardBody(
            [
               
             card_inside,
             html.Br(),
             look_at_your_team_container
...
layout = html.Div(children=main_card,style={'padding-top':'50px','padding-left':'50px','padding-right':'50px'})
